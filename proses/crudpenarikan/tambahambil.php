...
?>
    ...
    <div class ="pull-right">
                <a href="ambil.php" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-chevron-left"></i>Kembali</a>
                </div>

    <div class="container-fluid">
    <h2 align="center" class="pt-3 pb-3">Tambah Transaksi Penarikan</h2>
    <div class="row justify-content-center">
        <div class="col-sm-6 col-lg-5 ">
            <div class="card">
                <div class="card-body">
                <div class="hitung">
                <form method="post" action="../crudpenarikan/ambil_aksi.php">
                <div class="form-group ">
                    <label>Id Pegawai</label>
                  <input type="text" name="admin_id" class="form-control" placeholder="isi id pegawai" required>
                </div>
                <div class="form-group ">
                    <label>Id Nasabah</label>
                    <select name="rekening_id" id="rekening_id" class="form-control" onchange="changeValue(this.value)" required >  
